...
g <- ggplot(trends_rw_folds, aes(x = metric)) +
  ...
  xlab(NULL)
ggsave(path(figures_dir, "S3_proportion-cells_density-plot.png"), g,
       width = 7, height = 8, bg = "white")
ggsave(path(figures_dir, "S3_proportion-cells_density-plot.tiff"), g,
       width = 7, height = 8, bg = "white")
...
g <- ggplot(trends_rw_folds |>
  ...
  ylab("Relative number of species") +
  xlab(NULL)
ggsave(path(figures_dir, "S4_proportion-cells_density-plot_by-season.png"), g,
       width = 7, height = 8, bg = "white")
ggsave(path(figures_dir, "S4_proportion-cells_density-plot_by-season.tiff"), g,
       width = 7, height = 8, bg = "white")
