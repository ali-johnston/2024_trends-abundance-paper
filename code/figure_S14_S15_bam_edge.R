...
figures_dir <- path(base_dir, "figures/figure_S14_S15")
...
plot_loc <- path(figures_dir, paste0("fig_S14_linear-model_slope-histogram_", mod_tag, ".png"))
ggsave(plot_loc, width = 14, height = 10, units = "cm")

plot_loc <- path(figures_dir, paste0("fig_S14_linear-model_slope-histogram_", mod_tag, ".tif"))
ggsave(plot_loc, width = 14, height = 10, units = "cm")
...
#########################################################
## figure supp: 10-year-trend vs. abundance relationship
...
plot_loc <- path(figures_dir, paste0("figS15_bam_linear_slopes_edge_", no_yrs, "yr_", mod_tag, ".png"))
