...
plot_loc <- path(figures_dir, paste0("fig_S12_linear-model_slope-histogram_", mod_tag, ".png"))
ggsave(plot_loc, width = 14, height = 10, units = "cm")

plot_loc <- path(figures_dir, paste0("fig_S12_linear-model_slope-histogram_", mod_tag, ".tif"))
ggsave(plot_loc, width = 14, height = 10, units = "cm")
...
plot_loc <- path(figures_dir, paste0("fig_S13_linear-model_slopes_", mod_tag, ".tif"))
